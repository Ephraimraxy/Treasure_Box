...
import { User, Phone, MapPin, Building2, Shield, Camera, Lock, Search, CheckCircle, Loader2, Plus, Trash2, CreditCard, ChevronRight, ArrowLeft, Settings, HelpCircle, Bell, Fingerprint, KeyRound, FileText } from 'lucide-react';
...
// ─── Sub-page IDs ───
type SubPage = null | 'edit-profile' | 'bank-accounts' | 'virtual-account' | 'security';
    ...
    return (
        <div className="animate-fade-in max-w-lg mx-auto space-y-5">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden divide-y divide-slate-800/50">
                ...
                <MenuItem icon={KeyRound} label="Change Password" onClick={() => navigate('/forgot-password')} />
            </div>
            ...
            {/* ─── KYC CTA ─── */}
            {!user?.kycVerified && (
                <div className="bg-gradient-to-r from-amber-900/20 to-slate-800 border border-amber-500/20 rounded-2xl p-5">
                    <div className="flex items-start gap-3">
                        <div className="p-3 bg-amber-500/20 rounded-xl shrink-0"><Shield className="text-amber-500" size={24} /></div>
