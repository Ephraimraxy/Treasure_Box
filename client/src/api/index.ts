...
export const adminApi = {
    ...
    withdrawPaystack: (data: { amount: number; bankCode: string; accountNumber: string; accountName: string; description?: string; withdrawalType?: 'PROFIT' | 'WHOLE'; pin: string }) => api.post('/admin/paystack/withdraw', data),
